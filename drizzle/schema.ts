...
export const healthSources = mysqlTable("health_sources", {
  ...
  implementationStage: mysqlEnum("implementationStage", ["direct_oauth", "partner_required", "native_bridge", "legacy", "planned"]).notNull(),
  authType: mysqlEnum("authType", ["oauth2", "partner", "native_bridge", "manual", "legacy"]).notNull(),
